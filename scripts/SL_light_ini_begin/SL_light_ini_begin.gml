function SL_light_ini_begin() {
	...
	sl_light_power           = 1;       // Puissance de la lumière def 1
	sl_light_ambientpower    = 0;       // Puissance résiduelle de la lumière 
	sl_light_shadowlength    = 5;       // Longueur des ombres (détermine le nombre d'itérations)
	sl_light_shadowfactor    = 1.01;    // Grossissement appliqué à chaque sample d'ombre lors du rendu (doit être obligatoirement supérieur à 1)
	...
	sl_light_refreshrate     = 0.8;       // Fréquence de rafraîchissement des ombres, en steps (<=0 pour un rafraîchissement continu)
