...
description = (eng() ? ("Destroy a Lufulus' Wisdom.\n\nThey can be found at Spawn Areas.\nHarder areas have stronger wisdoms.\nDestroying them provides bonus\ndevelopment points.")
: ("Bir Lufulus'un Bilinci yok et.\n\nYaratık bölgelerinde bulunurlar.\nBölgenin seviyesine göre zihnin gücü de artar.\nOnları yok etmek gelişim puanı kazandırır."))
