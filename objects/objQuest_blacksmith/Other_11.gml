...
description = (eng() ? ("Find "+npc_goore+"'s special design sword by\ndestroying the creatures of the first wave\nat "+loc_wave1+".")
: (loc_wave1+"'deki ilk dalgayı savuşturarak "+npc_goore+"'un\nözel tasarım kılıcını bul."))
