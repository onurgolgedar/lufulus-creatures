...
description =
eng() ? ("The letter may explain creatures' unexpected\nbehaivors. Ask the Lord about the letter.")
: ("Mektup, belki yaratıkların beklenmedik\ndavranışlarını açıklayabilir. Lord'a\nmektubun içeriğini sor.")
