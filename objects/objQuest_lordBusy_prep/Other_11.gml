...
description = (eng() ? "Lord "+npc_lorddamph+" will talk you after the\nprisoned rebellion commender talks.\n\n[c="+string(c_aqua)+"]Reach level 19.[/c]"
: "Lord, kendisi asi komutanı konuşturduktan\nsonra seninle görüşmek isteyecek.\n\n[c="+string(c_aqua)+"]Seviye 19'a ulaş.[/c]")
