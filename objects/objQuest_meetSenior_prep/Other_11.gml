...
description = (eng() ? npc_lorddamph+" didn't say good things about you.\nYou have to improve yourself.\n\n[c="+string(c_aqua)+"]Reach level 3.[/c]"
: "Lord'un senin hakkında iyi şeyler söylemedi.\nKendini geliştirmelisin.\n\n[c="+string(c_aqua)+"]3. seviye ol.[/c]")
